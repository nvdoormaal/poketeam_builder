...
This makes it very easy to already build our urls that we can pass on to our scraper.
```{r build-links}
## We'll start with the pokemons from the first two generations, 1 to 251.
